...
with st.sidebar:
    st.title("MatriSure")
    st.write("Welcome to the MatriSure")
    st.write(" Choose an option from the menu below to get started:")

    selected = option_menu('MatriSure',
...
if (selected == 'About us'):
    st.title("Welcome to MatriSure")
    st.write("At MatriSure, our mission is to revolutionize healthcare by offering innovative solutions powered by advanced predictive analysis."
         "We are committed to transforming the way maternal and fetal health is monitored and managed, ensuring that every decision is informed, timely, and reliable. "
         "Our platform is specifically designed to address the intricate aspects of pregnancy, from identifying early risk factors to guiding proactive care strategies."
         )
    ...
    with col1:
        ...
        st.write("Our Pregnancy Risk Prediction feature utilizes advanced algorithms to analyze various parameters, including age, body sugar levels, blood pressure, and more. "
                 "By processing this information, we provide accurate predictions of potential risks during pregnancy."
                  "This empowers expectant mothers and healthcare providers to take proactive measures for a safer journey.")
        # Add an image for Pregnancy Risk Prediction
        st.image("graphics/matrisure_pregnancy.png", caption="Pregnancy Risk Prediction", use_container_width=True)
    with col2:
        ...
        st.image("graphics/matrisure_fetal.png", caption="Fetal Health Prediction", use_container_width=True)
    # Section 3: Dashboard
    ...
    # Closing note
    st.write("Thank you for choosing MatriSure. We are committed to advancing healthcare...")
